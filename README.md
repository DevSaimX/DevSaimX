...
|:-----------|:----------|:---------------|
| 📄 **Document-Based Q&A System** | `NLP` `RAG` `LLM` | Intelligent document querying using RAG pipelines |
...
| 💳 **Credit Card Fraud Detection** | `ML` `Scikit-learn` | Anomaly detection model for financial fraud |
| 🎙️ **Audio & Speech AI Systems** | `Voice AI` `Word Prediction` | Voice and word prediction AI pipeline |
...
🎤  Executive — BIIT TechFest 2025           Nov 2025 – Present
     Core exec for community engagement, outreach & large-scale event coordination

📡  Brand Ambassador — BIIT AI Society
...
📱  Community & Social Media Manager        BIIT AI Society / Programming Society
...
[![WhatsApp](https://img.shields.io/badge/WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://wa.me/923276931150)
